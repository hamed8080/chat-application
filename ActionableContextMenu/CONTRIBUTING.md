...
Thank you for considering contributing to ActionableContextMenu.

Please know that everyone is welcome to contribute to ActionableContextMenu.
...
ActionableContextMenu is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ActionableContextMenu,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/chat-app-extensions/issues/new/choose) 
...
All changes to ActionableContextMenu source must go through the PR review process before
being merged into the `main` branch.
See the [Code Contribution Guidelines](#code-contribution-guidelines) below for
more details.

## Building ActionableContextMenu

### Prerequisites

ActionableContextMenu is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/chat-app-extensions.git
    ```

2. Navigate to the root of your cloned repository with:

    ```bash
    cd ActionableContextMenu
    ```
...
4. Build ActionableContextMenu from the command line by running:
