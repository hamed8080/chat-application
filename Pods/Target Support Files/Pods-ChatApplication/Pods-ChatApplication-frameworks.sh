...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FanapPodAsyncSDK/FanapPodAsyncSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FanapPodChatSDK/FanapPodChatSDK.framework"
