...
Thank you for considering contributing to ChatAppExtensions.

Please know that everyone is welcome to contribute to ChatAppExtensions.
...
ChatAppExtensions is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatAppExtensions,
...
All changes to ChatAppExtensions source must go through the PR review process before
being merged into the `main` branch.
See the [Code Contribution Guidelines](#code-contribution-guidelines) below for
more details.

## Building ChatAppExtensions

### Prerequisites

ChatAppExtensions is a Swift package. If you're new to Swift package manager,
...
4. Build ChatAppExtensions from the command line by running:
