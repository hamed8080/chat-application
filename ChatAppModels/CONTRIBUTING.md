...
Thank you for considering contributing to ChatAppModels.

Please know that everyone is welcome to contribute to ChatAppModels.
...
ChatAppModels is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatAppModels,
...
All changes to ChatAppModels source must go through the PR review process before
being merged into the `main` branch.
See the [Code Contribution Guidelines](#code-contribution-guidelines) below for
more details.

## Building ChatAppModels

### Prerequisites

ChatAppModels is a Swift package. If you're new to Swift package manager,
...
4. Build ChatAppModels from the command line by running:
