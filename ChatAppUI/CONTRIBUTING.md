...
Thank you for considering contributing to ChatAppUI.

Please know that everyone is welcome to contribute to ChatAppUI.
...
ChatAppUI is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatAppUI,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/chat-app-ui/issues/new/choose) 
...
All changes to ChatAppUI source must go through the PR review process before
...
ChatAppUI is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/chat-app-ui.git
    ```
...
4. Build ChatAppUI from the command line by running:
