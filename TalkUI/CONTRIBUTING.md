...
Thank you for considering contributing to TalkUI.

Please know that everyone is welcome to contribute to TalkUI.
...
TalkUI is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to TalkUI,
...
All changes to TalkUI source must go through the PR review process before
...
TalkUI is a Swift package. If you're new to Swift package manager,
...
4. Build TalkUI from the command line by running:
